    ...
    if (pictureBox.includes(button.src)) {
        ...
        if (YesCount <= 10) {
            ...
            <div class="ffield">
                ...
                <button class="check"><a href='level7.html'><h3>следующий уровень?</h3></a></button>
            </div>
            `
        }
    } else {
...
function End() {
    ...
    <div class="ffield">        
        ...
        <h3>Вы прошли пять уровней. Максимально вы можете запомнить 10 картинок за раз, впечатляет</h3>
