    ...
    if (pictureBox.includes(button.src)) {
        ...
        if (YesCount <= 14) {
            ...
            <div class="ffield">
                ...
                <button class="check"><a href='Level9.html'><h3>следующий уровень?</h3></a></button>
            </div>
            `
        }
    } else {
...
function End() {
    ...
    <div class="ffield">        
        ...
        <h3>Вы прошли семь уровней. Максимально вы можете запомнить 14 картинок за раз, очень хорошо!</h3>
