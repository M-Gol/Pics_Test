...
function End() {
    ...
    <div class="ffield">        
        ...
        <h3>Вы прошли девять уровней. Максимально вы можете запомнить 18 картинок за раз, почти идеально, еще бы чуть-чуть!</h3>
...
let phot15 = photos[Math.floor(Math.random()*49)]
while (photoBox.includes(phot15)) {
    phot15 = photos[Math.floor(Math.random()*49)]
}
photoBox.push(phot15)
let phot16 = photos[Math.floor(Math.random()*49)]
while (photoBox.includes(phot16)) {
    phot16 = photos[Math.floor(Math.random()*49)]
}
photoBox.push(phot16)
let phot17 = photos[Math.floor(Math.random()*49)]
while (photoBox.includes(phot17)) {
    phot17 = photos[Math.floor(Math.random()*49)]
}
photoBox.push(phot17)
let phot18 = photos[Math.floor(Math.random()*49)]
while (photoBox.includes(phot18)) {
    phot18 = photos[Math.floor(Math.random()*49)]
}
photoBox.push(phot18)
let phot19 = photos[Math.floor(Math.random()*49)]
while (photoBox.includes(phot19)) {
    phot19 = photos[Math.floor(Math.random()*49)]
}
photoBox.push(phot19)
let phot20 = photos[Math.floor(Math.random()*49)]
while (photoBox.includes(phot20)) {
    phot20 = photos[Math.floor(Math.random()*49)]
}
photoBox.push(phot20)
...
box15.innerHTML = `<img src='${phot15}' alt='Будет фотка' id='pic15'>`
box16.innerHTML = `<img src='${phot16}' alt='Будет фотка' id='pic16'>`
box17.innerHTML = `<img src='${phot17}' alt='Будет фотка' id='pic17'>`
box18.innerHTML = `<img src='${phot18}' alt='Будет фотка' id='pic18'>`
box19.innerHTML = `<img src='${phot19}' alt='Будет фотка' id='pic19'>`
box20.innerHTML = `<img src='${phot20}' alt='Будет фотка' id='pic20'>`
...
pictureBox.push(document.getElementById('pic15').src)
pictureBox.push(document.getElementById('pic16').src)
pictureBox.push(document.getElementById('pic17').src)
pictureBox.push(document.getElementById('pic18').src)
pictureBox.push(document.getElementById('pic19').src)
pictureBox.push(document.getElementById('pic20').src)
