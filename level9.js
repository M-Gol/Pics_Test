    ...
    if (pictureBox.includes(button.src)) {
        ...
        if (YesCount <= 16) {
            ...
            <div class="ffield">
                ...
                <button class="check"><a href='Level10.html'><h3>следующий уровень?</h3></a></button>
            </div>
            `
        }
    } else {
...
function End() {
    ...
    <div class="ffield">        
        ...
        <h3>Вы прошли восемь уровней. Максимально вы можете запомнить 16 картинок за раз, фантастика!</h3>
