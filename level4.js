    ...
    if (pictureBox.includes(button.src)) {
        ...
        if (YesCount <= 6) {
            ...
            <div class="ffield">
                ...
                <button class="check"><a href='level5.html'><h3>следующий уровень?</h3></a></button>
            </div>
            `
        }
    } else {
...
function End() {
    ...
    <div class="ffield">        
        ...
        <h3>Вы прошли три уровня. Максимально вы можете запомнить 6 картинок за раз, достаточно неплохо</h3>
