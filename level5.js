    ...
    if (pictureBox.includes(button.src)) {
        ...
        if (YesCount <= 8) {
            ...
            <div class="ffield">
                ...
                <button class="check"><a href='Level6.html'><h3>следующий уровень?</h3></a></button>
            </div>
            `
        }
    } else {
...
function End() {
    ...
    <div class="ffield">        
        ...
        <h3>Вы прошли четыре уровня. Максимально вы можете запомнить 8 картинок за раз, неплохо</h3>
