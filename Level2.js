...
function End() {
    ...
    <div class="ffield">        
        ...
        <h3>Вы прошли только первый уровень. Максимально вы можете запомнить 2 картинки за раз</h3>
...
const pic3 = document.getElementById('pic3').src
const pic4 = document.getElementById('pic4').src
